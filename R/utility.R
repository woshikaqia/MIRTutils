...
#'  \code{prob} probability of correct response. When Rasch testlet model is involved, this is conditional probability given both overall and each node of the nuisance dimension \cr
#'  \code{escore} expected item score \cr
#'  \code{iteminfo} item information. When Rasch testlet model is involved, this is item info based on marginal prob of raw scores calculated using Lord-Wingerskey algorithm \cr
