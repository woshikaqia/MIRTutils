...
#' @description A set of functions to calculate some commonly used values when doing IRT analysis with new item types including
#' item bundles. IRT model currently supported are 1-3 PL, GPCM, Rasch Testlet Model, and a mix of these models.
