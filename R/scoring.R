#' IRT person scoring
#' @description Compute IRT latent scores (theta estimates). Model currently supported are 1-3 PL, GPCM, Rasch Testlet,
#' and a mix of these models. see \code{?MIRTutils} for model details. \cr
